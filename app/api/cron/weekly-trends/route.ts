// Vercel cron endpoint — runs weekly-trends.ts via dynamic require
// Schedule: Sundays 20:00 UTC (3 PM CST)
...
export async function GET(req: Request) {
  ...
  const scriptPath = path.resolve(process.cwd(), 'automation-os/scripts/weekly-trends.ts')
