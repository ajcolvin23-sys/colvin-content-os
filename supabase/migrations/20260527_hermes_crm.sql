...
drop policy if exists "hubs_owner" on hubs;
create policy "hubs_owner" on hubs for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "projects_owner" on projects;
create policy "projects_owner" on projects for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "crm_tasks_owner" on crm_tasks;
create policy "crm_tasks_owner" on crm_tasks for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "campaigns_owner" on campaigns;
create policy "campaigns_owner" on campaigns for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "research_notes_owner" on research_notes;
create policy "research_notes_owner" on research_notes for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "prompts_owner" on prompts;
create policy "prompts_owner" on prompts for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "crm_automations_owner" on crm_automations;
create policy "crm_automations_owner" on crm_automations for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "revenue_opportunities_owner" on revenue_opportunities;
create policy "revenue_opportunities_owner" on revenue_opportunities for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "hermes_agent_logs_owner" on hermes_agent_logs;
create policy "hermes_agent_logs_owner" on hermes_agent_logs for all using (auth.uid() = user_id or user_id is null);
drop policy if exists "hermes_approvals_owner" on hermes_approvals;
create policy "hermes_approvals_owner" on hermes_approvals for all using (auth.uid() = user_id or user_id is null);
